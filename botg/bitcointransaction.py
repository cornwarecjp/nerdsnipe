...
class Script:
	...
	@staticmethod
	def hashPubKey(dataHash, pubKeyHash):
		return Script((OP.HASH160, dataHash, OP.EQUALVERIFY, OP.DUP, OP.HASH160, pubKeyHash, OP.EQUALVERIFY, OP.CHECKSIG))


	@staticmethod
	def P2SHPubKey(script):
		scriptHash = RIPEMD160(SHA256(script.serialize()))
